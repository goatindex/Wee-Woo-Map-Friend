...
export const migrationDashboard = () => {
  console.warn('migrationDashboard: Legacy function called. Use DI container to get MigrationDashboard instance.');
  throw new Error('Legacy function not available. Use DI container to get MigrationDashboard instance.');
};
