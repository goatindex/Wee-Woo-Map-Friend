...
export const refactoredMapManager = () => {
  console.warn('refactoredMapManager: Legacy function called. Use DI container to get RefactoredMapManager instance.');
  throw new Error('Legacy function not available. Use DI container to get RefactoredMapManager instance.');
};
