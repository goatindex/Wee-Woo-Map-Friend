...
export const dependencyRegistry = () => {
  console.warn('dependencyRegistry: Legacy function called. Use DI container to get DependencyRegistry instance.');
  throw new Error('Legacy function not available. Use DI container to get DependencyRegistry instance.');
};
