...
export const sesUnitsLoader = () => {
  console.warn('sesUnitsLoader: Legacy function called. Use DI container to get SesUnitsLoader instance.');
  throw new Error('Legacy function not available. Use DI container to get SesUnitsLoader instance.');
};
