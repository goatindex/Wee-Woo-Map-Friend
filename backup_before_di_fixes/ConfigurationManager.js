...
export class ConfigurationManager extends BaseService {
  constructor(
    ...
    this.stateManager.set('config', this._config);
  ...
  _setValue(path, value) {
    ...
    // Emit change event
    this.eventBus.emit('config:change', { path, value, oldValue });
  ...
  import(configData) {
    if (configData && configData.config) {
      ...
      this.eventBus.emit('config:imported', { config: this._config });
...
export const configurationManager = () => {
  console.warn('configurationManager: Legacy function called. Use DI container to get ConfigurationManager instance.');
  throw new Error('Legacy function not available. Use DI container to get ConfigurationManager instance.');
};
