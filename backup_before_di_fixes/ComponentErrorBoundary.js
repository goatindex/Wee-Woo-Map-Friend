...
export class ComponentErrorBoundary extends BaseService {
  constructor(
    ...
    @inject(TYPES.ErrorBoundary) globalErrorBoundary,
    @inject(TYPES.UnifiedErrorHandler) unifiedErrorHandler,
...
export const componentErrorBoundary = () => {
  console.warn('componentErrorBoundary: Legacy function called. Use DI container to get ComponentErrorBoundary instance.');
  throw new Error('Legacy function not available. Use DI container to get ComponentErrorBoundary instance.');
};
