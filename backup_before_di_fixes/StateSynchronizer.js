...
export const stateSynchronizer = () => {
  console.warn('stateSynchronizer: Legacy function called. Use DI container to get StateSynchronizer instance.');
  throw new Error('Legacy function not available. Use DI container to get StateSynchronizer instance.');
};
