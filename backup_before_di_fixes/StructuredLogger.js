...
export const logger = {
  info: (message, metadata) => {
    console.warn('logger.info: Legacy function called. Use DI container to get StructuredLogger instance.');
    throw new Error('Legacy function not available. Use DI container to get StructuredLogger instance.');
  },
  error: (message, metadata) => {
    console.warn('logger.error: Legacy function called. Use DI container to get StructuredLogger instance.');
    throw new Error('Legacy function not available. Use DI container to get StructuredLogger instance.');
  },
  warn: (message, metadata) => {
    console.warn('logger.warn: Legacy function called. Use DI container to get StructuredLogger instance.');
    throw new Error('Legacy function not available. Use DI container to get StructuredLogger instance.');
  },
  debug: (message, metadata) => {
    console.warn('logger.debug: Legacy function called. Use DI container to get StructuredLogger instance.');
    throw new Error('Legacy function not available. Use DI container to get StructuredLogger instance.');
  },
  trace: (message, metadata) => {
    console.warn('logger.trace: Legacy function called. Use DI container to get StructuredLogger instance.');
    throw new Error('Legacy function not available. Use DI container to get StructuredLogger instance.');
  },
  createChild: (context) => {
    console.warn('logger.createChild: Legacy function called. Use DI container to get StructuredLogger instance.');
    throw new Error('Legacy function not available. Use DI container to get StructuredLogger instance.');
  }
};
