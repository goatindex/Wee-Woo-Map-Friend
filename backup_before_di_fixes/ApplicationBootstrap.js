...
export const applicationBootstrap = () => {
  console.warn('applicationBootstrap: Legacy function called. Use DI container to get ApplicationBootstrap instance.');
  throw new Error('Legacy function not available. Use DI container to get ApplicationBootstrap instance.');
};
