...
export const fabManager = () => {
  console.warn('fabManager: Legacy function called. Use DI container to get FABManager instance.');
  throw new Error('Legacy function not available. Use DI container to get FABManager instance.');
};
