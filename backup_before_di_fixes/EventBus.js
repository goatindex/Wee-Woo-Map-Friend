...
export class EventBus {
  constructor(
    ...
    this.logger = this.structuredLogger.createChild({ module: 'EventBus' });
  }
...
export const globalEventBus = {
  on: (event, listener, options) => {
    console.warn('globalEventBus.on: Legacy function called. Use DI container to get EventBus instance.');
    throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
  },
  once: (event, listener, options) => {
    console.warn('globalEventBus.once: Legacy function called. Use DI container to get EventBus instance.');
    throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
  },
  off: (event, listener) => {
    console.warn('globalEventBus.off: Legacy function called. Use DI container to get EventBus instance.');
    throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
  },
  emit: (event, data, options) => {
    console.warn('globalEventBus.emit: Legacy function called. Use DI container to get EventBus instance.');
    throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
  },
  emitAsync: (event, data) => {
    console.warn('globalEventBus.emitAsync: Legacy function called. Use DI container to get EventBus instance.');
    throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
  }
};
 ...
 */
export const on = (event, listener, options) => {
  console.warn('on: Legacy function called. Use DI container to get EventBus instance.');
  throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
};

export const once = (event, listener, options) => {
  console.warn('once: Legacy function called. Use DI container to get EventBus instance.');
  throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
};

export const off = (event, listener) => {
  console.warn('off: Legacy function called. Use DI container to get EventBus instance.');
  throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
};

export const emit = (event, data, options) => {
  console.warn('emit: Legacy function called. Use DI container to get EventBus instance.');
  throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
};

export const emitAsync = (event, data) => {
  console.warn('emitAsync: Legacy function called. Use DI container to get EventBus instance.');
  throw new Error('Legacy function not available. Use DI container to get EventBus instance.');
};
