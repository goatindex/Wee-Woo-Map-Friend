...
export class ComponentCommunication extends BaseService {
  constructor(
    ...
    @inject(TYPES.ComponentErrorBoundary) errorRecoveryService,
...
export const componentCommunication = () => {
  console.warn('componentCommunication: Legacy function called. Use DI container to get ComponentCommunication instance.');
  throw new Error('Legacy function not available. Use DI container to get ComponentCommunication instance.');
};