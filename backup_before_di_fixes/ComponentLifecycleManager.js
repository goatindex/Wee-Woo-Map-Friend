...
export const componentLifecycleManager = () => {
  console.warn('componentLifecycleManager: Legacy function called. Use DI container to get ComponentLifecycleManager instance.');
  throw new Error('Legacy function not available. Use DI container to get ComponentLifecycleManager instance.');
};
