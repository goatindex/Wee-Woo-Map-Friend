...
export const cfaFacilitiesLoader = () => {
  console.warn('cfaFacilitiesLoader: Legacy function called. Use DI container to get CfaFacilitiesLoader instance.');
  throw new Error('Legacy function not available. Use DI container to get CfaFacilitiesLoader instance.');
};
