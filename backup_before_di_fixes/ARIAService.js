...
export const ariaService = () => {
  console.warn('ariaService: Legacy function called. Use DI container to get ARIAService instance.');
  throw new Error('Legacy function not available. Use DI container to get ARIAService instance.');
};
