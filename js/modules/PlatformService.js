...
export class PlatformService extends BaseService {
  ...
  private generateOptimizations(): IPlatformOptimizations {
    ...
    const enableServiceWorker = capabilities.serviceWorker && environmentConfig.isServiceWorkerEnabled();
    ...
    const enableExperimentalFeatures = environmentConfig.isDebugToolsEnabled();
    const enableDebugFeatures = environmentConfig.isDebugToolsEnabled();
  ...
  getDebugInfo(): any {
    return {
      ...
      config: environmentConfig.getAllConfig(),
