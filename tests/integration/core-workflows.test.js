 ...
 * 2. Search & Activation Workflow
 * 3. Active List Management (Emphasize, Labels, Weather)
 * 4. Data Loading & Layer Management
 * 5. Reset & State Management
...
test.describe('Core Workflows Integration', () => {
  ...
  test.describe('2. Search & Activation Workflow', () => {
  ...
  test.describe('3. Active List Management Workflow', () => {
  ...
  test.describe('4. Data Loading & Layer Management', () => {
  ...
  test.describe('5. Reset & State Management', () => {
  ...
  test.describe('6. Error Recovery & Resilience', () => {
